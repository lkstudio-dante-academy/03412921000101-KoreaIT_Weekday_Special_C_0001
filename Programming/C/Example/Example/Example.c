/*
* 전처리기 (Preprocessor) 란?
* - C/C++ 로 작성 된 명령문을 기계어로 변환하기 전에 명령문을 튜닝하는 프로그램을 의미한다. (+ 즉,
* C/C++ 로 작성 된 명령문은 전처리기에 의해 변경 될 수 있다는 것을 알 수 있다.)
*
* 전처리기에 의해 처리되는 명령문은 C/C++ 과 다른 문법을 사용하며 모든 명령문이 # 기호로
* 시작하는 특징이 존재한다.
*
* 주요 전처리기 명령어 종류
* - #define
...
*
* C/C++ 은 파일 단위로 컴파일이 이루어지기 때문에 다른 파일에 존재하는 기능 (+ Ex. 함수) 을
...
*
* 헤더 (Header) 파일이란?
* - C/C++ 로 작성 된 명령문의 정보를 다른 파일에 공유하기 위한 목적으로 작성하는 파일을 의미한다.
* (+ 즉, #include 명령어를 통해 헤더 파일을 가져옴으로서 다른 파일에 존재하는 정보를 공유하는 것이
* 가능하다.)
*
* 소스 (Source) 파일이란?
* - C/C++ 명령문을 작성하는 파일을 의미한다. (+ 즉, 소스 파일에 작성 된 명령문은
* C/C++ 컴파일러에 의해서 기계어로 변환 된다는 것을 알 수 있다.)
*
* C/C++ 소스 파일 확장자는 .c or .cpp 를 사용하며 .c 확장자로 된 파일은 C 컴파일러에 의해서
...
* 주석을 활용하면 C/C++ 로 작성 된 명령문을 좀 더 쉽게 이해 할 수 있게 정보를 남기는 것이
* 가능하다.)
*
* C/C++ 주석 종류
* - 단일 행 주석 (//)
...
* - C/C++ 로 제작 된 프로그램이 실행 될 때 가장 먼저 호출되는 함수를 의미한다. (+ 즉,
* 메인 함수가 호출 되었다는 것은 프로그램이 실행 되었다는 것을 의미한다.)
*
* 또한 메인 함수가 종료되면 프로그램이 종료되는 특징이 존재한다. (+ 즉, 메인 함수는
* C/C++ 로 제작 된 프로그램의 시작이자 끝이라는 것을 알 수 있다.)
*
* 메인 함수는 C/C++ 로 제작 된 프로그램의 시작이자 끝이기 때문에 반드시 작성해줘야한다. (+ 즉,
* 메인 함수를 작성하지 않으면 프로그램 제작이 불가능하다는 것을 알 수 있다.)
*
* 함수 (Function) 란?
* - C/C++ 로 작성 된 명령문을 담고 있는 기능을 의미한다. (+ 즉, 함수를 호출하면
