...
* 
* C/C++ 은 문자열을 의미하는 별도의 자료형이 존재하지 않지만 char 배열을 이용해서 문자열을
* 표현하는 것이 가능하다.
* 
...
* - strlen			<- 문자열 길이 반환
* 
* C/C++ 은 배열을 통해 문자열을 표현하기 때문에 문자열을 대상으로 변수처럼 연산자를 사용하는 것이
* 불가능하다.
* 
* 따라서 C/C++ 은 문자열을 제어하기 위한 여러 함수를 제공하며 해당 함수들을 활용하면 좀 더
