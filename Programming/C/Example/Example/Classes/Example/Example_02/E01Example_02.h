...
*
* C/C++ 자료형 종류 - 정수 (Integer)
* - short : 2 Byte
* - int : 4 Byte
* - long : 4 Byte or 8 Byte
* - long long : 8 Byte
*
* C/C++ 자료형 종류 - 실수 (Floating Point)
* - float : 4 Byte
* - double : 8 Byte
*
* C/C++ 자료형 종류 - 문자
* - char : 1 Byte
*
* 위와 같이 C/C++ 는 다양한 자료형을 지원하며 해당 자료형을 이용해서 목적에 맞게
* 데이터를 처리하는 것이 가능하다.
*
* 또한 C/C++ 와 같은 프로그래밍 언어에서 데이터의 최소 단위는 일반적으로 바이트를 사용한다. (+ 즉,
...
*
* C/C++ 은 signed or unsigned 키워드를 정수형 자료형 앞에 명시함으로서
...
*
* C/C++ 이름 작성 규칙
* - C/C++ 에서 이름에 사용 할 수 있는 문자 종류는 알파벳 대/소문자, _ (언더 스코어), 숫자 만을
* 사용하다.
*
* C/C++ 은 알파벳 대/소문자, _ (언더 스코어), 숫자를 조합해서 자유롭게 이름을 작성하는 것이
