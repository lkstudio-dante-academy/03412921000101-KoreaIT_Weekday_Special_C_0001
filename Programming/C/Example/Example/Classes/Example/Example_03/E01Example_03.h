...
/*
* 컴퓨터가 데이터를 표현하는 방법
* - 컴퓨터는 내부적으로 사용하는 모든 데이터를 0 과 1 로 이루어 진 2 진수 (Binary Number) 를 통해
* 표현한다. (+ 즉, 컴퓨터는 숫자만을 다루는 기계라는 것을 알 수 있다.)
*
...
*
* 2 진수 <-> 8 진수 간에 변환 방법
* - 2 진수 3 자리는 8 진수 1 자리로 표현이 가능하기 때문에 이를 활용하면 2 진수 <-> 8 진수 간에
* 변환을 간단하게 계산하는 것이 가능하다.
*
* Ex)
* 110 011 001 <-> 631
*
...
*
* 2 진수 <-> 16 진수 간에 변환 방법
* - 2 진수 4 자리는 16 진수 1 자리로 표현이 가능하기 때문에 이를 활용하면 2 진수 <-> 16 진수 간에
* 변환을 간단하게 계산하는 것이 가능하다.
*
* Ex)
* 1100 0011 <-> C3
